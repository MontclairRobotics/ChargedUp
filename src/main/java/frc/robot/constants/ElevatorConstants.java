...
public class ElevatorConstants
{
    ...
    public static final double MID_HEIGHT  = MAX_HEIGHT - Units.inchesToMeters(12);//Units.feetToMeters(2.0 + 10.0/12) - ELEVATOR_MIN_TO_FLOOR + GRABBER_HEIGHT_NO_OBJECT;
