...
/**
 * NOTE: copied from https://github.com/6391-Ursuline-Bearbotics/BearSwerve/blob/master/src/main/java/frc/swervelib/SwerveDrivetrainModel.java
 * Modified by team 555
 */ 
public class SwerveDriveModel555 
{
    //#region Original Code (BearSwerve)
    ...
    public SwerveDriveModel555(ArrayList<SwerveModule> realModules, Gyroscope gyro)
    {
        this.gyro = gyro;
