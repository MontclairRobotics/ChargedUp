...
public class LimelightConstants
{
    ...
    public static final double FORWARD_OFFSET = Units.inchesToMeters( 12.375);
    public static final double SIDE_OFFSET = Units.inchesToMeters(0);
    public static final double UP_OFFSET = Units.inchesToMeters(16);
