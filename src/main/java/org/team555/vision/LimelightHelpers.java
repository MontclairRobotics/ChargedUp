...
public class LimelightHelpers {
    ...
    public static class FiducialTarget {
    ...
    public static class BarcodeTarget {
    ...
    public static class InternalResults {
        ...
        @JsonProperty("Retro")
        public RetroTarget[] targets_Retro;
        ...
        public InternalResults() {
            ...
            targets_Retro = new RetroTarget[0];
    ...
    public static class Results {
        ...
        public InternalResults targetingResults;

        public Results() {
            targetingResults = new InternalResults();
        }
    }
    ...
    public static Results getLatestResults(String limelightName) {
        ...
        LimelightHelpers.Results results = new LimelightHelpers.Results();
        if (mapper == null) {
            mapper = new ObjectMapper().configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
        }

        try {
            results = mapper.readValue(getJSONDump(limelightName), Results.class);
